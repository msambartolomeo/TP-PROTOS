...
static enum connectionMethod choose_method(enum connectionMethod current,
                                           enum connectionMethod new) {
...
static void connection_parse_byte(struct connectionParser * parser,
                                  uint8_t byte) {
    switch (parser->state) {
